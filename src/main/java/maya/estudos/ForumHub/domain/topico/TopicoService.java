...
import maya.estudos.ForumHub.domain.curso.CursoService;
import maya.estudos.ForumHub.domain.topico.validacao.atualizacao.ValidacaoAtualizacaoTopico;
import maya.estudos.ForumHub.domain.topico.validacao.criacao.ValidacaoCriacaodeTopico;
...
public class TopicoService {
    ...
    public DadosTopicoResponse criarTopico(DadosTopicoCadastro cadastro) {
        ...
        validacoesCriacao.forEach(validacao -> validacao.validar((DadosTopicoCadastro) cadastro));
